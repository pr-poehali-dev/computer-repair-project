...
const Index = () => {
  ...
  const services = [
    ...
    },
    {
      ...
      description: 'Ремонт утюгов, фенов, пылесосов, микроволновок и другой бытовой техники. Диагностика и восстановление.',
      gradient: 'from-secondary to-accent'
    },
    {
      icon: 'Globe',
      title: 'Создание сайтов',
      description: 'Разработка современных сайтов для вашего бизнеса. Визитки, лендинги, интернет-магазины под ключ.',
      gradient: 'from-accent to-primary'
    }
  ];
